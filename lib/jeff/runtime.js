...
// BEGIN(BROWSER)
    ...
    // hook that allows you to post-process elements, attributes, children, etc
    Jeff.afterElementProcessed = function(e) {
        console.log('using aep');
        return e;
    };
    ...
    Jeff.elem = function(tagName) { // like this: elem("div", attributes, children, text);
        ...
        if ( arguments.length > 1 ) {
            ...
            e = Jeff.afterElementProcessed(e);
        }
