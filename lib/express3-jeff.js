...
function ExpressJeff(config) {
    config = config || {};

    var jeff = config.jeff || require('./jeff');
    ...
    this.jeffVersion = ExpressJeff.getJeffSemver(jeff);
...
ExpressJeff._dirCache     = {};
ExpressJeff._fileCache    = {};
ExpressJeff._pendingReads = {};

ExpressJeff.getJeffSemver = function (jeff) {
    var version = jeff.VERSION || '';

    // Makes sure the Jeff version is a valid semver.
...
extend(ExpressJeff.prototype, {
    ...
    loadTemplate: function (filePath, options, callback) {
        ...
        compile = this.jeff[precompiled ? 'precompile' : 'compile'];
    ...
    render: function (filePath, options, callback) {
        ...
        var helpers = extend({},
            this.jeff.helpers, this.helpers, options.helpers);
    ...
    _loadDir: function (dirPath, options, callback) {
        ...
        var dirCache     = ExpressJeff._dirCache,
            pendingReads = ExpressJeff._pendingReads,
    ...
    _loadFile: function (filePath, options, callback) {
        ...
        var fileCache    = ExpressJeff._fileCache,
            pendingReads = ExpressJeff._pendingReads,
